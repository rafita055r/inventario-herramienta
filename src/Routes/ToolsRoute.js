    ...
    return (
        <main className='main-tool'>
            ...
            <div className='contain-search-input' >
                <input type="text" name='search-tool' className="input-search-tool" placeholder="Buscar herramientas" defaultValue={dataSearching} onChange={handleSearching} />
                <button onClick={onClickSearch} className="btn-search-tool" ><IoMdSearch /></button>
            </div>
